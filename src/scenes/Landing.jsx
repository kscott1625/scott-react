      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="tracking-wide mt-14 mb-7 text-md text-center md:text-start">
            Hi! I'm Katherine, a Front-End Developer based in Seattle, WA. I have spent many years in healthcare and now expanding my talents into writing clean code. I have a passion for creating engaging, entertaining user experiences. 
          </p>
        </motion.div>
